                                ...
                                <div id="input" class="p-5">
                                    <div class="preview">
                                        <div>
                                            ...
                                            <input id="dni" name="dni" type="number" readonly
                                        ...
                                        <div class="mt-3">
                                            ...
                                            <input id="territorial" type="text" class="form-control"
                                                name="territorial" placeholder="Territorial">
                                        </div>
                                        <div class="mt-3">
                                        ...
                                        <div class="mt-3">
                                            ...
                                            <div class="input-group mt-2">
                                                ...
                                                <div id="togglePassword" class="input-group-text cursor-pointer"><i
                                                        class="open" data-feather="eye"></i><i class="closed"
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <div class="mt-2">
                                            <select data-placeholder="Seleccione un rol para el usuario" name="role_id"
                                                id="role_id" class="tom-select w-full">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <div class="mt-2">
                                            <select data-placeholder="Seleccione una delegación para el usuario"
                                                name="delegation_id" id="delegation_id" class="tom-select w-full">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <div class="mt-2">
                                            <select data-placeholder="Seleccione un rol para el usuario" name="group_id"
                                                id="group_id" class="tom-select w-full">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <div class="mt-2">
                                            <select data-placeholder="Seleccione un rol para el usuario"
                                                name="quartile_id" id="quartile_id" class="tom-select w-full">
                                    ...
                                    <div class="modal-footer my-5">
                                        ...
                                        <div class="alert alert-danger my-3" role="alert" style="display:none;"
