...
@section('subhead')
<title>Actualizar contenido - Adopción</title>
@endsection

@section('subcontent')
<div id="alert" class="hidden"></div>
<div class="intro-y flex flex-col sm:flex-row items-center mt-8">
  <h2 class="text-lg font-medium mr-auto">Actualizar contenido para Adopción</h2>
  <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
    <button id="update-adoption" class="btn btn-primary shadow-md flex items-center" aria-expanded="false">
...
<div id="form-body" class="pos intro-y grid grid-cols-12 gap-5 mt-5">
  ...
  <div class="intro-y col-span-12 lg:col-span-9">
    <div class="form-inline mt-3 mb-2">
      ...
      <select name="campaign" data-placeholder="Seleccione una Campaña" class="campaign-adoption-select form-control tom-select w-full mb-2">
    ...
    <div class="form-inline mb-2">
      ...
      <select name="section" data-placeholder="Seleccione una sección" class="section-adoption-select form-control tom-select w-full mb-2">
...
<script>
      document.querySelector('.campaign-adoption-select').tomselect.addItem('{{ $article->campaign_id }}');
      document.querySelector('.section-adoption-select').tomselect.addItem('{{ $article->section_id }}');
    ...
    // SI ES UNRESTRICTED NO TIENES QUE HACER NADA PORQUE ES VISIBLE PARA TODOS
      if(unrestricted == 1) {
        ...
        $.ajax({
          ...
          url: "/api/posts/adoption/filters/" + id,
   ...
   $('#update-adoption').on('click', function (e) {
    e.preventDefault();
