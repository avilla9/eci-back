...
@section('subhead')
<title>Actualizar contenido - Accesos</title>
@endsection

@section('subcontent')
<div id="alert" class="hidden"></div>
<div class="intro-y flex flex-col sm:flex-row items-center mt-8">
  <h2 class="text-lg font-medium mr-auto">Actualizar contenido para la sección Accesos</h2>
  <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
    <button id="update-access" class="btn btn-primary shadow-md flex items-center" aria-expanded="false">
...
<div id="form-body" class="pos intro-y grid grid-cols-12 gap-5 mt-5">
  ...
  <div class="intro-y col-span-12 lg:col-span-9">
    <div class="form-inline mt-3 mb-2">
      ...
      <select name="section" data-placeholder="Seleccione una sección" class="section-access-select form-control tom-select w-full mb-2">
...
<script src="{{ asset('dist/js/articles/access.js') }}"></script>
<script>
    document.querySelector('.section-access-select').tomselect.addItem('{{ $article->section_id }}');
    ...
    // SI ES UNRESTRICTED NO TIENES QUE HACER NADA PORQUE ES VISIBLE PARA TODOS
      if(unrestricted == 1) {
        ...
        $.ajax({
          ...
          url: "/api/posts/access/filters/" + id,
   ...
   haveFilters("{{ $article->unrestricted }}");
    ...
    $('#update-access').on('click', function (e) {
        e.preventDefault();
