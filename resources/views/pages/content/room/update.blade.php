...
@section('subhead')
<title>Actualizar contenido - Salas</title>
@endsection

@section('subcontent')
<div id="alert" class="hidden"></div>
<div class="intro-y flex flex-col sm:flex-row items-center mt-8">
  <h2 class="text-lg font-medium mr-auto">Actualizar contenido para la sección Salas</h2>
...
<div id="form-body" class="pos intro-y grid grid-cols-12 gap-5 mt-5">
  ...
  <div class="intro-y col-span-12 lg:col-span-9">
    <div class="form-inline mt-3 mb-2">
      ...
      <select name="section" data-placeholder="Seleccione una sección" class="section-room-select form-control tom-select w-full mb-2">
...
<script>
   document.querySelector('.section-room-select').tomselect.addItem('{{ $article->section_id }}');
