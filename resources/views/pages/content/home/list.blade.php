                  ...
                  <!-- BEGIN: Post Content -->
                    <div class="intro-y col-span-12 lg:col-span-9">
                        ...
                        <select name="section" data-placeholder="Seleccione una sección" class="form-control tom-select w-full mb-2" id="section">
                            ...
                            <option value="{{$section->id}}" id="option">{{$section->title}}</option>
                            @endforeach
                        </select>
                        </div>
                        <div class="form-inline mb-2">
                        <label for="horizontal-form-2" class="form-label font-bold sm:w-20">Título</label>
                        <input name="title" id="horizontal-form-2" type="text" class="title form-control" placeholder="Título del post">
                        </div>
                        <div class="form-inline mb-2">
                        <label for="horizontal-form-2" class="form-label font-bold sm:w-20">Descripción corta</label>
                        <input name="short_description" id="horizontal-form-2" type="text" class="short_description form-control" placeholder="Descripción corta">
                        </div>
                        <div class="form-inline mb-2">
                        ...
                        <div class="flex flex-col sm:flex-row content-center">
                            ...
                            <input id="radio-switch-4" class="form-check-input post" type="radio" name="post_type" value="post">
                            <label class="form-check-label" for="radio-switch-4">Post</label>
                            </div>
                            <div class="form-check mr-2 mt-2 sm:mt-0">
                            <input id="radio-switch-5" class="form-check-input external" type="radio" name="post_type" value="external">
                            <label class="form-check-label" for="radio-switch-5">Enlace externo</label>
                            </div>
                            <div class="form-check mr-2 mt-2 sm:mt-0">
                            <input id="radio-switch-6" class="form-check-input internal" type="radio" name="post_type"
                                value="internal">
