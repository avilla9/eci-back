		...
		let table = new Tabulator("#home-tabulator", {
			...
			},
			{
				...
				formatter(cell, formatterParams) {
					let a =
						$(`<div class="flex lg:justify-center items-center">
                    <a data-tw-target="#edit-home" data-tw-toggle="modal" data-backdrop="static" data-keyboard="false" class="edit flex items-center mr-3" href="javascript:;">
                        <i data-feather="check-square" class="w-4 h-4 mr-1"></i> Editar
                    </a>
                    <a class="delete flex items-center text-danger" href="javascript:;">
                        <i data-feather="trash-2" class="w-4 h-4 mr-1"></i> Eliminar
