...
(function () {
                    ...
                    <a class="delete flex items-center text-danger" href="javascript:;">
                        ...
                        $(a)
                            ...
                            .on("click", function () {
                                ...
                                $("#role_id")
                                    .val(cell.getData().role_id)
                                    .attr("selected", "selected");

                                $("#delegation_id")
                                    .val(cell.getData().delegation_id)
                                    .attr("selected", "selected");

                                $("#group_id")
                                    .val(cell.getData().group_id)
                                    .attr("selected", "selected");

                                $("#quartile_id")
                                    .val(cell.getData().quartile_id)
                                    .attr("selected", "selected");
                            });
        ...
        function updateUser(data) {
            $.ajax({
                ...
                error: function (error) {
                    ...
                    if (errors === undefined) {
                        $("#alertUpdateFailed").html(
                            "Ha ocurrido un error al actualizar la contraseña, por favor intente de nuevo."
                        );
    ...
    if ($("#home-tabulator").length) {
        // Setup Tabulator
        let table = new Tabulator("#home-tabulator", {
            ajaxURL: "/api/posts/home/list",
            ajaxFiltering: true,
            ajaxSorting: true,
            printAsHtml: true,
            printStyled: true,
                    ...
                    <a class="delete flex items-center text-danger" href="javascript:;">
                        ...
                        $(a)
							...
							//    });
                                ...
                                // $(".external").attr('checked', false);

                                // if(cell.getData().post_type == 'post') {
                                // 	$(".post").attr('checked', 'checked');
                                // } else if(cell.getData().post_type == 'external') {
                                // 	$(".external").attr('checked', 'checked');
                                // } else {
                                // 	$(".internal").attr('checked', 'checked');
                                // }

                                // $('.external_link').val(cell.getData().external_link);
                                // $('.datepicker').val(cell.getData().created_at);
                            });
                        ...
                        $(a)
                            ...
                            .on("click", function () {
                                Swal.fire({
                                    ...
                                    if (result.isConfirmed) {
                                        fetch("/api/posts/home/article-delete", {
                                            method: "POST",
                                            headers: {
                                                "Content-type":
                                                    "application/json;charset=UTF-8",
